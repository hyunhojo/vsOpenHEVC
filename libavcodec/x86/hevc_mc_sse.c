    ...
    if (!(width & 7)) {
        ...
        for (y = 0; y < height + qpel_extra[1]; y ++) {
            for (x = 0; x < width; x += 2) {
                ...
                _mm_maskmoveu_si128(x2,rBuffer,(char *) (tmp+x));
        ...
        for (y = 0; y < height; y ++) {
            for(x=0;x<width;x+=2){
                ...
                // give results back
                _mm_maskmoveu_si128(r1,rBuffer,(char *) (dst+x));
        ...
        if (!(width & 7)) {
            ...
            for (y = 0; y < height; y ++) {
                for(x=0;x<width;x+=2){
                    ...
                    _mm_maskmoveu_si128(r0,rBuffer,(char *) (dst+x));
        ...
        if (!(width & 7)) {
            ...
            for (y = 0; y < height + qpel_extra[3]; y ++) {
                for (x = 0; x < width; x += 2) {
                    ...
                    /* give results back            */
                    //  _mm_maskmove_epi8((__m128i *) &tmp[x], x2);
                    _mm_maskmoveu_si128(x2,r1,(char *) (tmp+x));
